...
import HomeUpgrade from './HomeUpgrade.jsx'
...
function RootApp() {
  ...
  return <><LiveActivity /><KorapayBranding />{session ? <><GrowviaPolishedV2 /><HomeUpgrade user={session.user} /><PwaInstallPrompt /></> : <AuthGate />}</>
}
